...
<head>
<meta charset="utf-8"/>
<title><s:property value="course.courseTitle"/></title>
...
<div class="page-container">
	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu " data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					<a href="<s:url action="instructedCourses"/>">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<s:property value="course.courseTitle"/>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#"><s:property value="course.courseTitle"/></a>
						<i class="fa fa-angle-right"></i>
					</li>
				</ul>
			</div>
										...
										<div class="col-md-3 col-sm-4 mix category_1">
											<div class="mix-inner">
												...
												<div class="mix-details">
													<h4><s:property value="lectureTitle"/> </h4>
													<h4><s:property value="lectureDescription"/>  </h4>
													<a class="mix-preview fancybox-button" href="http://localhost:8080/hello/metronic/templates/frontend/lectureLoad?lectureID=<s:property value="lectureID"/>"  title="Project Name" data-rel="fancybox-button">
				...
				<div class="margin-top-10">
									...
									<div class="col-md-3 col-sm-4 mix category_1">
											<div class="mix-inner">
												...
												<div class="mix-details">
													<h4>NEW LECTURE</h4>
													<h3>Create a new Lecture </h4>
													<a class="mix-preview fancybox-button" href="http://localhost:8080/hello/metronic/templates/frontend/newLectureAdd?courseID=<s:property value="courseID"/>" title="Create" data-rel="fancybox-button">
									...
									<div class="col-md-3 col-sm-4 mix category_1">
											<div class="mix-inner">
												...
												<div class="mix-details">
													...
													<a class="mix-preview fancybox-button" href="http://localhost:8080/hello/metronic/templates/frontend/getStudentsPerformance?courseID=<s:property value="courseID"/>" title="Create" data-rel="fancybox-button">
													<i class="fa fa-plus"></i>
													</a>
												</div>
											</div>
