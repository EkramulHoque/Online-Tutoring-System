	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				...
				<s:form action="openCourse" method="post" class="form-horizontal" role="form">
					<fieldset>
										<s:fielderror fieldName="newCourseID"/>
										<s:fielderror fieldName="newCourseTitle"/>
										<s:fielderror fieldName="newCourseDescription]"/>
					
					<div class="form-body">
						<div class="form-group">
							<label class="col-md-3 control-label">Course ID</label>
							<div class="col-md-4">
								<input name="newCourseID" id="newCourseID" type="text" class="form-control input-circle" placeholder="Example: CSE220">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input name="newCourseTitle" id="newCourseTitle" type="text" class="form-control input-circle" placeholder="Example: Data Structure">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<textarea name="newCourseDescription" id="newCourseDescription" class="col-md-10 form-control input-circle" placeholder="Example: Introduction to widely used and effective methods of data organisation, focussing on data structures, their algorithms and the performance of these algorithms." rows="8"></textarea>
