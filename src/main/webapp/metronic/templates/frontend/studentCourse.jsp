		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					...
					<s:property value="%{student.firstname}"/> <s:property value="%{student.lastname}"/> </span>
					<i class="fa fa-angle-down"></i>
					</a>
					<ul class="dropdown-menu">
						<li>
							<a href="<s:url action="userProfileStudent"/>">
	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu " data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					<a href="<s:url action="findCourse"/>">
					<i class="fa fa-plus-square color-grey"></i>
					<span class="title">Find A New Course</span>
					</a>
				</li>
				<li>
					<a href="<s:url action="enrolledCourses"/>">
									...
									<div class="col-md-3 col-sm-4 mix category_1">
											<div class="mix-inner">
												...
												<div class="mix-details">
													...
													<a class="mix-preview fancybox-button" href="http://localhost:8080/hello/metronic/templates/frontend/getOwnPerformance?courseID=<s:property value="courseID"/>" title="Create" data-rel="fancybox-button">
