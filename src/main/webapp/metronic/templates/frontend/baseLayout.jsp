	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu " data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					<a href="javascript:;">
					<i class="fa fa-bar-chart-o color-grey"></i>
	...
	<div class="col-md-6 col-sm-6 padding-top-10">
		...
		name="userDownload"/>
		     <s:submit value="submit" name="submit" />
				...
				<div class="col-md-4 col-sm-4 padding-top-10" id="Exam" style="display:none">
                      <div class="service-box-v1">
                        <div><i class="fa fa-cloud-download color-grey"></i></div>
                        <h2><a href="<s:url action="examAction"/>">Exam</a></h2>
                    ...
                    <div class="col-md-4 col-sm-4 padding-top-10" id="uploadBtn" style="display: none">
                      <div class="service-box-v1">
                        <div><i class="fa fa-cloud-download color-grey"></i></div>
                        <h2><a href="videoUpload.jsp">Upload</a></h2>
