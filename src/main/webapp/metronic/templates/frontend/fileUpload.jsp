			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="<s:url action="userProfile"/>">
		...
		<div class="page-content">
			...
			<!-- BEGIN PAGE CONTENT-->
              ...
              <div class="col-md-6 col-sm-6 padding-top-10">
                	...
                	<h4>Create an excel sheet with .xlsx file format and name it</h4><br>
                	<h4>Take the first seven(7) columns for the sheet</h4><br>
                	<h4>Column 1: Question Number, Column 2: Question, 
                		Column 3-6: Four Options,Column 7: answer which is the letter among the option(A-D)</h4><br>
                		<h4>Set the first 5 questions as easy, the next 5 questions as moderate and the last 5 to be hard
                		for setting the difficulty level</h4>
                	</div>
                	<div class="col-md-6 col-sm-6 padding-top-10">
                	<img src="../../assets/frontend/layout/img/logos/clue.jpg" width="350px" height="250px">
		      ...
		      <input name="lectureID" value="<s:property value="lectureID"/>">
		      </div>    
		      
		      <p>Set Duration:
    <input type="number" id="hours" name="hour" min="0" value="0"  size=3 style="width:50px"/>Hr
    <input type="number" id="minutes"  min="0" max="59" name="minute" value="2" size=2 style="width:50px"/>Min
    <input  type="number" id="seconds" min="0" max="59" name="second"  value="0" size=2 style="width:50px"/>Sec
