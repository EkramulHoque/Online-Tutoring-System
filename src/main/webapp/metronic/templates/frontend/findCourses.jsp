			...
			<ul class="page-sidebar-menu " data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<ul class="sub-menu">
						...
						<li>
							<a href="http://localhost:8080/hello/metronic/templates/frontend/studentCourse?courseID=<s:property value="courseID"/>">
							...
							<div class="tab-pane active" id="tab_1">
								...
								<div class="margin-top-10">
									<div class="row mix-grid">
										...
										<s:iterator value="otherCourses">
										<div class="col-md-3 col-sm-4 mix category_1">
											<div class="mix-inner">
												<img class="img-responsive" src="../../assets/admin/pages/media/works/img1.jpg" alt="">
												<div class="mix-details">
													<h4><s:property value="courseID"/></h4>
													<h4><s:property value="courseTitle"/> </h4>
													<h6><s:property value="courseDescription"/></h6>
													<a class="mix-preview fancybox-button" href="http://localhost:8080/hello/metronic/templates/frontend/enrollCourse?newEnrolledCourseID=<s:property value="courseID"/>" title="Enroll" data-rel="fancybox-button">
