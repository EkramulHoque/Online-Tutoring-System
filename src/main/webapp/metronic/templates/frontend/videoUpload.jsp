		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu " data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<span class="title">Student's Performance</span>
					</a>
				</li>
			</ul>
			<!-- END SIDEBAR MENU -->
		...
		<div class="page-content">
			...
			<div class="row">
			 <div class="container">
               ...
               <h2>Upload new video for the lecture or lecture materials</h2>
                	<h4>Allowed types for video: .mp4,mpeg</h4>
                	<h4>Allowed types for file: .ppt , .docx , .xlsx</h4>
                	
               <s:form  action="VideoUpload" method="post" enctype="multipart/form-data">
