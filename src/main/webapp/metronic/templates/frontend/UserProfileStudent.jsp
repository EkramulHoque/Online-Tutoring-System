...
<script>
var split;
var imgSource="../../assets/frontend/layout/img/media/";
   function previewFile(){
       var preview = document.getElementById('PID'); //selects the query named img
  ...
  previewFile();  //calls the function named previewFile()
	...
	function pictureLoad(){
		document.getElementById("PID").src='${photoPath}';
		alert('${photoPath}');
		}
				...
				<li class="dropdown dropdown-user">
					...
					<ul class="dropdown-menu">
						<li>
							...
							<a href="<s:url action="userProfileStudent"/>">My Profile </a>
						</li>
						
						<li>
							<a href="<s:url action="logout"/>">Sign Out</a></a>
						</li>
					</ul>
				</li>
