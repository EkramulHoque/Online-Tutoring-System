		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">Student's Performance</a>
					</li>
				</ul>
				...
				<div class="col-md-6">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>Quiz Marks
							</div>
						</div>
						<div class="portlet-body">
							<div class="table-scrollable">
								...
								<tbody>
								<s:iterator value="firstname" status="stat">	
								...
								<tr>
									...
									<td>
										 <s:property value="firstname[#stat.count-1]"/>
									</td>
									<td>
										 <s:property value="lastname[#stat.count-1]"/>
									</td>
									<td>
										 <s:property value="lecture[#stat.count-1]" />
									</td>
									<td>
										 <s:property value="marks[#stat.count-1]"/>
									</td>
