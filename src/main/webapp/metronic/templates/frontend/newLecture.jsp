	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				...
				<s:form action="newLecture" method="post" class="form-horizontal" role="form">
					<fieldset>
					...
					<div class="form-body">
						<div class="form-group">
							...
							<div class="col-md-4">
								<input name="newLectureTitle" id="newLectureTitle" type="text" class="form-control input-circle" placeholder="Example: Data Structure">
								
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label">Lecture Description</label>
							<div class="col-md-4">
								<textarea name="newLectureDescription" id="newLectureDescription" type="text" class="col-md-10 form-control input-circle" placeholder="Example: Introduction to widely used and effective methods of data organisation, focussing on data structures, their algorithms and the performance of these algorithms." rows="8"></textarea>
