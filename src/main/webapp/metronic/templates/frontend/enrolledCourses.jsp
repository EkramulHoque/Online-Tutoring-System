										...
										<div class="col-md-3 col-sm-4 mix category_1">
											<div class="mix-inner">
												...
												<div class="mix-details">
													...
													<a class="mix-preview fancybox-button" href="http://localhost:8080/hello/metronic/templates/frontend/studentCourse?courseID=<s:property value="courseID"/>" title="Enter" data-rel="fancybox-button">
